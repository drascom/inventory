...
class WeatherForecast {
    ...
    async getForecast (coordinates) {
        ...
        let endpoint = `https://api.openweathermap.org/data/2.5/weather?lat=${coordinates.latitude}&lon=${coordinates.longitude}&appid=${appId}&units=metric&lang=tr`;
    ...
    getErrorData() {
        return {
            ...
            {
                id: 0,
                description: 'There is a problem at the weather forecast server ¯\\_(ツ)_/¯'
            }],
            name: null,
            sys: {
                country: null
