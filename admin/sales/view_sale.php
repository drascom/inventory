<?php
$qry = $conn->query("SELECT s.*, c.name as client_name FROM sales_list s 
...
<div class="card card-outline card-primary">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div><?php echo isset($client_name) ? $client_name : '' ?></div>
                    </div>
                </div>
            </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary"
            href="<?php echo base_url . '/admin?page=sales/manage_sale&id=' . (isset($id) ? $id : '') ?>">Edit</a>
