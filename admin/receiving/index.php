                ...
                <table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        ...
                        while ($row = $qry->fetch_assoc()):
                            ...
                            if ($row['from_order'] == 1) {
                                $code = $conn->query("SELECT po_code from `purchase_order_list` where id='{$row['purchase_id']}' ")->fetch_assoc()['po_code'];
                            } else {
                                $code = $conn->query("SELECT bo_code from `back_order_list` where id='{$row['purchase_id']}' ")->fetch_assoc()['bo_code'];
                            }
                            ?>
                            <tr>
